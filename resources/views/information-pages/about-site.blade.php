...
@section('content')
    ...
    <div id="about-us" class="info-section large-text">
        ...
        <p><span>Fanfics Club</span> створений як платформа, де автори можуть ділитися своїми творами, а читачі — насолоджуватися необмеженою кількістю історій із своїх улюблених всесвітів. Від класичних фандомів до оригінальних творів — ми підтримуємо творчість у всіх її проявах.</p>
        ...
        <p>Ми віримо, що кожен має право на творчість та самовираження. Тому наш сайт надає інструменти для <a
            ...
            <a href="https://t.me/fanfics_club_ua">обговорення</a> фанфіків. Ми прагнемо забезпечити дружнє та підтримуюче середовище для усіх учасників нашої спільноти.</p>

        <p>Запрошуємо вас долучитися до нашої спільноти. Незалежно від того, чи ви автор, чи читач, на <span>Fanfics Club</span> ви знайдете місце, де можна поділитися своєю пасією до фанфіків. Разом ми створюємо не лише колекцію творів, а й теплу атмосферу, де кожен може відчути себе частиною чогось великого.</p>
    ...
    <div id="contact-us" class="info-section">
        ...
        <ul class="normal-list">
            <li>Email: <a href="mailto: info@fanfics.club">info@fanfics.club</a></li>
            <li>Telegram канал: <a href="https://t.me/fanfics_club_ua">@fanfics_club_ua</a></li>
